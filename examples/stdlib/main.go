...
import (
	...
	"github.com/charlires/go-openapi-gen/examples/stdlib/handlers/topic/post"
	"github.com/charlires/go-openapi-gen/examples/stdlib/handlers/topics/get"
...
func main() {
	...
	api.StripPkgPaths = []string{"github.com/charlires/go-openapi-gen/example", "github.com/a-h/respond"}
